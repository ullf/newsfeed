...
Route::get('showcomment/{id}','ReadCommentController@show')->name('showcomment');
Route::get('comment_edit',function () { return view("comment_edit"); });
...
Route::get('publisher/{name}','PublisherController@show')->name('publishershow');
